...
<head>
  ...
  <title>Contact Us | FoodVit</title>
</head>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#"><img src="../../assets/FoodyVit.png" alt="" /></a>
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-link active" href="../pages/menu.php">Menu</a>
          <a class="nav-link active" href="../pages/service.php">Service</a>
      ...
      <div class="drop-down">
        <div class="container">
          ...
          <button class="btnaccount"><span><?= $username; ?></span>
            <img padding="12px" width="20" height="20" src="https://img.icons8.com/ios/50/000000/user-male-circle--v1.png" alt="user-male-circle--v1" />
            <ul class="dropdown">
  ...
  <section id="menu">
    <div class="container">
      ...
      <div class="row text-end">
        <div class="col">
          <a class="link" href=""><i class="bi bi-list" style="color: black; font-size: 20px"></i>
            Lihat Menu</a>
        </div>
      </div>
      ...
      <div class="row text-center">
        <div class="col">
          ...
          <div class="input-group flex-nowrap">
            <input type="text" class="form-control" placeholder="Ketik Email" aria-label="Username" aria-describedby="addon-wrapping" />
          </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <p>
              ...
              <a href="https://www.instagram.com/Mvhenix"><i class="bi bi-instagram"></i></a>
              <a href="https://www.twiiter.com"><i class="bi bi-twitter"></i></a>
              <a href="https://www.youtube.com/Miawaug" target="_blank"><i class="bi bi-youtube"></i></a>
            </p>
          </div>
          <div class="col-lg-2">
            <h5>Information</h5>
